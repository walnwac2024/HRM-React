  ...
  return (
    <>
      ...
      <div className="bg-white border-b rounded-t-xl mb-3 sm:mb-4">
        <div className="px-2 sm:px-4 py-1.5 sm:py-2 flex gap-2 overflow-x-auto snap-x snap-mandatory">
          {[
            "Home",
            "HR Dashboard",
            "Payroll Dashboard",
            ...
            <button
              key={tab}
              aria-selected={i === 0}
              className={`px-3 sm:px-4 py-1.5 text-[11px] sm:text-[12px] uppercase tracking-wide rounded-t-md border snap-start
                ${i === 0
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-4">
        ...
        <section className="lg:col-span-3 space-y-3 sm:space-y-4">
          ...
          {/* Attendance alert */}
          <div className="bg-white rounded-xl shadow border overflow-hidden">
            <div className="px-3 sm:px-4 py-2.5 sm:py-3 text-[12px] sm:text-[13px] font-semibold text-gray-700">ATTENDANCE</div>
        ...
        <section className="lg:col-span-6 space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x">
              <div className="p-0">
                <div className="flex items-center justify-between bg-gray-100 px-3 sm:px-4 py-2">
                  <div className="text-[11px] sm:text-[12px] uppercase font-semibold text-gray-600">Missing Attendance</div>
                </div>
              ...
              <div className="p-0">
                <div className="flex items-center justify-between bg-gray-100 px-3 sm:px-4 py-2">
                  <div className="text-[11px] sm:text-[12px] uppercase font-semibold text-gray-600">Attendance Summary</div>
                </div>
                <div className="p-2.5 sm:p-3">
                  <div className="overflow-x-auto rounded border">
          ...
          <div className="bg-white rounded-xl shadow border overflow-hidden">
            <div className="flex items-center justify-between bg-gray-100 px-3 sm:px-4 py-2">
              <div className="text-[11px] sm:text-[12px] uppercase font-semibold text-gray-600">Employee KPI</div>
