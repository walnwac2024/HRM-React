...
export default function Dashboard() {
  ...
  return (
    <>
      {/* Secondary Tabs (under the main topbar) */}
        ...
        <div className="px-4 py-2 flex gap-2 overflow-x-auto">
          {[
            ...
            <button
              key={tab}
              aria-selected={i === 0}
              className={`px-4 py-2 text-[12px] uppercase tracking-wide rounded-t-md border
                ${i === 0
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <section className="lg:col-span-3 space-y-4">
          ...
          {/* Attendance alert */}
          <div className="bg-white rounded-xl shadow border overflow-hidden">
            <div className="px-4 py-3 text-[13px] font-semibold text-gray-700">ATTENDANCE</div>
            <div className="px-4 pb-4">
              <div className="rounded-lg border border-red-200 bg-red-50 text-red-600 p-3 text-[13px]">
          ...
          {/* Leave Summary */}
          <div className="bg-white rounded-xl shadow border overflow-hidden">
            <div className="px-4 py-3 text-[13px] font-semibold text-gray-700">LEAVE SUMMARY</div>
            <div className="px-4 pb-4">
              ...
              {[
                ...
                <div key={r.label} className="flex items-center justify-between py-2 border-t first:border-t-0">
                  ...
                  <span className="px-2 py-1 rounded bg-gray-100 text-[12px]">{r.value}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="lg:col-span-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x">
              <div className="p-0">
                <div className="flex items-center justify-between bg-gray-100 px-4 py-2">
                  <div className="text-[12px] uppercase font-semibold text-gray-600">Missing Attendance</div>
                </div>
                <div className="p-3">
              ...
              <div className="p-0">
                <div className="flex items-center justify-between bg-gray-100 px-4 py-2">
                  <div className="text-[12px] uppercase font-semibold text-gray-600">Attendance Summary</div>
                </div>
                <div className="p-3">
                  <div className="overflow-auto rounded border">
                    <table className="w-full text-[12px]">
          ...
          <div className="bg-white rounded-xl shadow border overflow-hidden">
            <div className="flex items-center justify-between bg-gray-100 px-4 py-2">
              <div className="text-[12px] uppercase font-semibold text-gray-600">Employee KPI</div>
              <div className="text-[12px] text-gray-500">Sumitha Thomas</div>
            </div>
            <div className="p-3">
              <div className="overflow-auto rounded border">
                <table className="w-full text-[12px]">
                  ...
                  <tbody>
                    {kpiRows.map((row) => (
                      <tr key={row} className="border-t">
                        ...
                        <td className="p-2">
                          <span className="inline-block h-3 w-28 bg-gray-100 rounded" />
                        </td>
                      </tr>
                    ))}
                  </tbody>
        ...
        <section className="lg:col-span-3 space-y-4">
            ...
            <div className="p-4 space-y-2 text-sm text-gray-700">
              {[
                ...
                <div key={label} className="flex items-center justify-between">
                  <span>{label}</span>
                  <span className="px-2 py-0.5 rounded bg-gray-100 text-[12px]">0</span>
                </div>
              ))}
          ...
          {/* News */}
          <div className="bg-white rounded-xl shadow border overflow-hidden">
            <div className="px-4 py-3 text-[13px] font-semibold text-gray-700">News</div>
            <div className="px-4 pb-4 text-xs text-gray-500">No record found</div>
          </div>
        </section>
      </div>
    </>
