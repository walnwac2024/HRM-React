          ...
          <table className="table">
            <thead className="thead">
              <tr>
                ...
                <th className="th w-44">Date</th>
                <th className="th w-36">Flag Type</th>
            ...
            <tbody>
              {rows.length === 0 && (
                <tr>
                  <td className="td text-center text-sm text-gray-500" colSpan={10}>
                    No record found
                  </td>
                </tr>
              )}
              ...
              {rows.map((row, idx) => {
                ...
                const employeeDetails =
                  pick(row, "employeeDetails", "details.employee", "employee.details") || "—";
                ...
                return (
                  <tr key={row.id ?? idx} className="row tr">
                    ...
                    <td className="td text-sm text-gray-700">{employeeDetails}</td>
                    <td className="td">{date || "—"}</td>
                    <td className="td">{flagType || "—"}</td>
