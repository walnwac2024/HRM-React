...
import {
  ...
  FaCalendarCheck, FaChartLine, FaThLarge, FaChartBar, FaBell
} from "react-icons/fa";
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="mx-auto max-w-screen-2xl h-14 px-4 flex items-center">
                ...
                >
                  <Icon
                    className={`text-[18px] mb-1 ${
                      isActive ? "text-customRed" : "text-slate-500 opacity-80 group-hover:text-customRed"
                    }`}
                  />
          ...
          <div className="ml-5 pl-5 border-l border-gray-200 flex items-center gap-4">
            <button className="relative text-slate-500 hover:text-customLightGrey" aria-label="Notifications">
